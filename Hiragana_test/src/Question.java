...
public class Question {
	...
	private void question19() {
		...
		int a = scanner.nextInt();
		switch (a) {
		case 1: System.out.println("오답! (답은 3번)");
		break;
		
	    case 2: System.out.println("오답! (답은 3번)");
	    break;
	    
	    case 3: System.out.println("정답!");
	    break;
	    
     	case 4: System.out.println("오답! (답은 3번)");
	    break;
	    
    	case 5: System.out.println("오답! (답은 3번)");
	    break;
		}
		start();
	}
	...
	private void question18() {
		...
		int a = scanner.nextInt();
		switch (a) {
		case 1: System.out.println("오답! (답은 4번)");
		break;
		
	    case 2: System.out.println("오답! (답은 4번)");
	    break;
	    
	    case 3: System.out.println("오답! (답은 4번)");
	    break;
	    
     	case 4: System.out.println("정답!");
	    break;
	    
    	case 5: System.out.println("오답! (답은 4번)");
	    break;
		}
		start();
	}
	...
	private void question17() {
		...
		int a = scanner.nextInt();
		switch (a) {
		case 1: System.out.println("오답! (답은 2번)");
			break;
			
		case 2: System.out.println("정답!");
		    break;
		    
		case 3: System.out.println("오답! (답은 2번)");
		    break;
		}
		start();
	}
	...
	private void question11() {
		...
		int a = scanner.nextInt();
		switch (a) {
		case 1: System.out.println("정답!");
			break;
			
		case 2: System.out.println("오답! (답은 1번)");
		    break;
		    
		case 3: System.out.println("오답! (답은 1번)");
		    break;
		}
		start();
	}
	...
	private void question10() {
		...
		case 4: System.out.println("오답! (답은 1번)");
		    break;
		    
		case 5: System.out.println("오답! (답은 1번)");
		    break;
	...
	private void question9() {
		...
		int a = scanner.nextInt();
		switch (a) {
		case 1: System.out.println("오답! (답은 5번)");
			break;
			
		case 2: System.out.println("오답! (답은 5번)");
		    break;
		    
		case 3: System.out.println("오답! (답은 5번)");
		    break;
		    
		case 4: System.out.println("오답! (답은 5번)");
		    break;
		    
		case 5: System.out.println("정답!");
		    break;
	...
	private void question6() {
		...
		case 4: System.out.println("오답! (답은 2번)");
		    break;
		    
		case 5: System.out.println("오답! (답은 2번)");
		    break;
